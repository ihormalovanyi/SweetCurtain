# SweetCurtain
A framework that provides [Curtain Controller](#curtaincontroller). [Curtain Controller](#curtaincontroller) is a container view controller that implements a content-curtain interface. 
